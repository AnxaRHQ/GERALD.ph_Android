package anxa.com.geraldph.customview;
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener
{
    ...
    public void onShowCustomView(View view, CustomViewCallback callback)
    {
    	...
    	if (view instanceof FrameLayout)
        {
    		...
    		System.out.println(" A video wants to be shown");
            ...
            System.out.println(" Save video related variables");
        	// Save video related variables
            this.isVideoFullscreen = true;
            this.videoViewContainer = frameLayout;
            this.videoViewCallback = callback;

            System.out.println(" Hide the non-video view, add the video view, and show it"+activityNonVideoView+" "+activityVideoView);
        	// Hide the non-video view, add the video view, and show it
            activityNonVideoView.setVisibility(View.INVISIBLE);
            activityVideoView.addView(videoViewContainer, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
            ...
            else
            {
                ...
                // Test case: TextureView of Sony Xperia T API level 16 doesn't work fullscreen when loading the javascript below
            	 System.out.println("HTML 5 step 2");
                 
            	if (webView != null && webView.getSettings().getJavaScriptEnabled() && focusedChild instanceof SurfaceView)
                {
            		 System.out.println("HTML 5 step 1");
                    ...
                    js += "}";
                    System.out.println("HTML 5 step 3");
            ...
            {
            	 System.out.println("HTML 5 step 4");
        	...
        	//change orienttaion here to alwasy have a landscape in video
        }
    }
	...
	public boolean getIsrotate() {
		...
		if (isVideoFullscreen)
        {
            return true; //rotate to landscape
        }
        else
        {
